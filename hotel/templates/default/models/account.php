                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach($result_booking as $i => $row){ ?>
                                        <tr>
                                            <td><?php echo strftime(DATE_FORMAT." ".TIME_FORMAT, $row['add_date']); ?></td>
                                            <td><?php echo strftime(DATE_FORMAT, $row['from_date']); ?></td>
                                            <td><?php echo strftime(DATE_FORMAT, $row['to_date']); ?></td>
