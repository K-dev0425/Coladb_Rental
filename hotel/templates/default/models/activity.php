                ...
                <div class="col-md-8 mb20">
                    <div class="row mb10">
                        <div class="col-sm-8">
                            ...
                            <p class="text-muted">
                                <i class="fa fa-clock-o"></i> <?php echo $texts['DURATION']; ?> <?php echo $activity['duration']." ".$texts[mb_strtoupper($activity['duration_unit'])]; ?>
                            </p>
                        </div>
                                ...
                                <a href="<?php echo DOCBASE.$page['alias']."/".text_format($activity_alias); ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-8">
                                            ...
                                            <p class="text-muted">
                                                <i class="fa fa-clock-o"></i> <?php echo $duration_value." ".$texts[mb_strtoupper($duration_unit)]; ?>
                                            </p>
                                            <?php
