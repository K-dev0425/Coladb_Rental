                    ...
                    <div class="mb5 mt5 bg-success">
                        ...
                        <div class="col-md-3 col-lg-2 pt5 pb5">
                            <div class="input-group input-group-sm">
                                <div class="input-group-addon"><i class="fa fa-male"></i> '.$texts['ADULTS'].'</div>
                                <select name="num_adults['.$room_id.']['.$i.']" class="form-control sendAjaxForm selectpicker" data-extratarget="#booking-amount" data-action="'.getFromTemplate('common/change_num_people.php').'?index='.$i.'&id_room='.$room_id.'" data-target="#room-result-'.$room_id.'-'.$i.'">
                        ...
                        <div class="col-md-3 col-lg-2 pt5 pb5">
                            <div class="input-group input-group-sm">
                                <div class="input-group-addon"><i class="fa fa-male"></i> '.$texts['CHILDREN'].'</div>
