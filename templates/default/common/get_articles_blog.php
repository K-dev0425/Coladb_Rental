    ...
    foreach($result_article as $i => $row){
        ...
        <article class=\"blog-article col-sm-12 mb20".$tags."\" itemprop=\"blogPosts\" itemscope itemtype=\"http://schema.org/BlogPosting\">
            ...
            <div class=\"mt10 labels\" dir=\"ltr\">
                <span class=\"label label-default\"><i class=\"fa fa-thumb-tack\"></i> 
                ...
                if($result_users->execute() != false){
                    foreach($result_users as $user_article)
                        $html .= "<span class=\"label label-default\"><i class=\"fa fa-user\"></i> <span itemprop=\"creator author publisher\">".$user_article['login']."</span></span>";
                }
                ...
                if($result_tag !== false){
                    ...
                    if($nb_tags > 0){
                        $html .= "<span class=\"label label-default\"><i class=\"fa fa-tags\"></i> ";
