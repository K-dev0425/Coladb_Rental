                            ...
                            <div class="col-md-10 mt20">
                                <div class="btn-group">
                                    ...
                                    if($prev_article === false){ ?>
                                        <span class="btn btn-default disabled"><i class="fa fa-arrow-left"></i></span>
                                        <?php
                                    }else{ ?>
                                        <a href="<?php echo DOCBASE.$prev_article['alias']; ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i></a>
                                        <?php
                                    } ?>
                                    <a href="<?php echo DOCBASE.$page['alias']; ?>" class="btn btn-default"><?php echo $texts['BACK']; ?></a>
                                    <?php
                                    if($next_article === false){ ?>
                                        <span class="btn btn-default disabled"><i class="fa fa-arrow-right"></i></span>
                                        <?php
                                    }else{ ?>
                                        <a href="<?php echo DOCBASE.$next_article['alias']; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i></a>
                                        <?php
                                    } ?>
                                </div>
                            </div>
