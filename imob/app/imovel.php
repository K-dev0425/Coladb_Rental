...
class Imovel extends PHP
{
    ...
    public function fillSimilares( $i )
    {
        ...
        if ( $this->result() )
        {
            ...
            $rep = array( 'Vendido', 'Alugado', 'Lançamento', 'Pronto para morar', 'Em construção', 'Oportunidade', 'Financie', 'Decorado', 'Para renda', 'Alugue', 'CondomÃ­nio', 'Cobertura' );
