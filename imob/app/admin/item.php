...
class Item extends PHP
{
	...
	{	
		// coloque aqui sua KEY do google
		$api_key = 'AIzaSyAXQtGJOVNF96nSCbcaqLRrL1El5Gpe4OU';

		$url = "https://maps.google.com/maps/api/geocode/json?address=" . urlencode( utf8_encode($address) ) . "&region=Brazil&sensor=false&key=$api_key";
		$curl = curl_init();
