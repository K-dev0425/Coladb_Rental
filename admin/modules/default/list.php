                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if(VALIDATION && (in_array('publish', $permissions) || in_array('all', $permissions))){
                                                                    if($checked == 0){ ?>
                                                                        ...
                                                                        <a class="tips" href="index.php?view=list&id=<?php echo $id; ?>&csrf_token=<?php echo $csrf_token; ?>&action=archive" title="<?php echo $texts['ARCHIVE']; ?>"><i class="fa fa-archive text-warning"></i></a>
                                                                        <?php
                                                                    }elseif($checked == 1){ ?>
